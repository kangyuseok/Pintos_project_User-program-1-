...
static inline bool //list가 head 포인터 이면 true
...
/* Returns true if ELEM is an interior element,
   false otherwise. */
static inline bool //list가 중간에 있으면 true
...
static inline bool //list가 맨 마지막 tail일 경우 true
...
{
  ASSERT (list != NULL); //에러검출용 list가 null이면 에러 
  list->head.prev = NULL;
